...
// import org.deepsymmetry.bcj.StateListener;
...
//     private static int virtualCdjDevicenumber = 0;
...
//      */
//     public static void main(String[] args) {    //ToDo: Hier eigenen code einfügen
//         OBCgui.init();
//         initButtons();
...
//                 // // get beatphase and set Display
//                 // if(virtualCdjStarted){  //ToDo: getting beatphase even when vcdj is not running yet
//                 //     if(VirtualCdj.getInstance().isTempoMaster()){   //we are Master    
//                 //         double _barphase = VirtualCdj.getInstance().getPlaybackPosition().getBarPhase();    // get beatphase
//                 //         // OBCdisplay.setBarphase(_barphase);
//                 //         System.out.println("barphase: " + _barphase);
//                 //     }else{  //we are not master (CDJ is )
...
//                 //read buttons
//                 if(virtualCdjStarted && !buttonMaster.isPressed()){
//                     System.out.print("try to become master...");
//                     try {
//                         VirtualCdj.getInstance().becomeTempoMaster();
//                         System.out.println("We're master now.");
//                     } catch (IOException e) {
//                         System.out.println("we didn't become Master :(");
//                         // e.printStackTrace();
//                     }
...
//         // Carabiner.getInstance().addStateListener(new StateListener() {
//         //     @Override
//         //     public void carabinerStatusReceived(State state) {
//         //         if(VirtualCdj.getInstance().isTempoMaster()){   //set master bool to display
//         //             OBCdisplay.setPlayerMaster(VirtualCdj.getInstance().getDeviceNumber(), true);
//         //             virtualCdjDevicenumber = VirtualCdj.getInstance().getDeviceNumber();
//         //         }

//         //         // throw new UnsupportedOperationException("Unimplemented method 'carabinerStatusReceived'");
//         //     }
//         // });
...
//                 if(VirtualCdj.getInstance().isTempoMaster()){
//                     OBCdisplay.setPlayerMaster(VirtualCdj.getInstance().getDeviceNumber(), true);
//                 }
...
//                                     vcdjOnline = true;
//                                     System.out.println("bridemode established\n");
